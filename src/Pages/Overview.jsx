  ...
  const historicalChanges = [
    {
      ...
      text: "춘추전국 시대는 끊이지 않는 전쟁으로 혼란스러웠고, 기존의 가치관과 제도가 무너지면서 사람들은 도덕적 지침과 사회 질서 회복을 갈망했다. 이러한 시기에 등장한 공자는 세상이 혼란스러운 이유가 개인의 윤리의식이 타락했기 때문이며 모든 사람의 윤리의식이 높아지면 좋은 세상이 온다고 생각했다. 따라서 공자는 스스로가 어떻게 군자와 성인이 될 수 있는지를 고민하는 개인 윤리를 집대성했고 이를 ‘유학'이라 한다. 이후 공자의 제자였던 맹자는 공자의 가르침을 보완하고 확장했으며, 남송 시대 유학자 주자는 공자, 맹자, 순자 등 유교 성현들의 학설을 바탕으로 성리학을 완성했다.",
    },
    {
      class: "고려시대",
  ...
  return (
    <div className="background">
      ...
      <div className="overview-container">
        ...
        <OverviewContent title="기본 이념" type="bottom" contents={coreIdeology} />
